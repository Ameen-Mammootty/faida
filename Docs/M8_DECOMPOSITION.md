...
**Decided by the founder 2026-09-04:** P1, P2, P3, P4, P5, P7 and P8 as recommended; **P6 overridden** - no founder-track F9 is created, and the real till export moves to M11 with the pilot, where the first real upload proves the layout step (`plan.md` Decision Log 2026-09-04 and the M11 checklist).
