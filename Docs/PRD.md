...
14. Run a **staff incentive** on the till's own figures - a scheme month, push weeks, a daily scoreboard to the branch phone and an owner-approved statement - never paid on contribution (§33).
...
Every morning at 07:00 in the branch's own timezone, the branch's registered WhatsApp phone receives a **scoreboard** card: this week's push list with each item's portions so far against target and what a portion above target earns, the month's net sales so far against target, the pool so far marked "so far", and the newest loaded day with its age in its first line.
