...
description: >
  ...
  accent, the three-step gray text ladder, Manrope (display/numerals/chrome) + Manrope (body),
...
colors:
  ...
  text-muted: "#52625D"
  text-light: "#9A9A9A"
  accent-light: "rgba(21, 62, 53, 0.08)"
  accent-medium: "rgba(21, 62, 53, 0.15)"
  border: "rgba(21, 62, 53, 0.2)"
  card-bg: "rgba(21, 62, 53, 0.04)"
  gold: "#E3A13B" # Faida brand: Karak Gold, accents only (a chip, a tick mark, the mark's leaf) - never text, never a fill larger than a chip
  gold-soft: "#F8EED9" # pale gold: review-required / attention surfaces
  positive: "#1D6D50"
  negative: "#65415F"
...
typography:
  ...
  # — display / numerical ramp (Manrope, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Manrope", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Manrope", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Manrope", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Manrope", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Manrope", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Manrope", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Manrope", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Manrope** (display) / **Inter** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 470, 500, 600, 700, 750, 760}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is two faces in fixed roles: **Manrope** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Manrope** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Manrope** (display/numerals/chrome) + **Manrope** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Manrope body 0.85cqw muted; Manrope eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Manrope `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Manrope 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Manrope `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Manrope label + muted desc + optional
...
blockquote, cite. **Focal** a Manrope `blockquote` near-black under a 15%-opacity cobalt
...
Manrope body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Manrope `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Manrope 400 muted, line 1.6.
...
- **Type** — Manrope headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Manrope body muted line 1.6; ≥1.4cqw floor.
...
- **Manrope + Manrope via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
