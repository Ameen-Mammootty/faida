...
- [ ] Versioned recipes and conversions; every cost result names the recipe version and the
...
**VERDICT:** ENG CLEARED — ready to implement, pending founder go-ahead on the decomposition
and its three named scope proposals (the per-branch template cut, margin net of VAT, the
EDGE-01 pull-in).
