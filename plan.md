...
- 2026-08-28 - **Migration 0011 applied to the live project; the C8 deploy-order debt is cleared.**
  ...
  Remaining before the next live forward: deploy to Railway, then warm the v3 grammar with `python -m eval.schema_probe` so the first real invoice does not pay the ~2-3 minute first-compilation cost.
