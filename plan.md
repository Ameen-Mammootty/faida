...
proposals decided (Decision Log); WP-60 and WP-61 shipped 2026-08-30.
...
- [ ] **Margin per item at its menu price:** cost, margin in AED, margin %, and what is missing.
      ...
      *(the API answer shipped with WP-61 - quality, missing list, margin net of VAT; the box
      closes when WP-62 puts it on the screen)*
